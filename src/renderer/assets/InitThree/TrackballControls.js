...
var TrackballControls = function ( object, domElement ) {
	...
	this.rotateCamera = ( function () {
        ...
        // 控制点中心也旋转
        if(_this.plateCenter) {
          _this.target.applyMatrix4(new THREE.Matrix4().makeTranslation(-_this.plateCenter.x, -_this.plateCenter.y,-_this.plateCenter.z))
  ...
  this.getDistance = function () {
    ...
    return _this.object.position.distanceTo(  _this.target );
